...
/**
 *Klasa wyszukująca inwentarz o podanym id.
 */
@SpringBootApplication
public class InventoryDemoSearch implements CommandLineRunner {
    
    public static void main(String[] args) {
		SpringApplication.run(InventoryDemoSearch.class, args);       
	}
    ...
    @Override
        public void run(String... args) throws Exception
        {
            ...
            String resourceURL = "http://dymek.utp.edu.pl:8097/api/v1/inventory/cellid/4400006600";
